 ...
 */
 ...
 <!-- Jquery plugins dependencies of product widget -->
<script>  
 ...
 */
 ...
 // $('.input-mask-size').mask('YYY.YY x YYY.YY x YYY.YY',options);
...
<script>
	...
	/**
	* Hangle logic for process of uploading image area.
	* if has image in src attribute then view image, else view upload area
 	*/
	...
	/**
	 * add submit handler for product form
	 */
