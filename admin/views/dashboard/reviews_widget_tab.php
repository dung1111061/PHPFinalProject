<?php
$avatar_url = AVATAR_IMAGE_URL."default.png";
$username = "Bob Doe";
$time = "6 min";
...
<div class="comments">
	...
	<div class="itemdiv commentdiv">
		<div class="user">
			<img alt="Jennifer's Avatar" src="<?=AVATAR_IMAGE_URL."default.png"?>" />
		</div>
	...
	<div class="itemdiv commentdiv">
		<div class="user">
			<img alt="Joe's Avatar" src="<?=AVATAR_IMAGE_URL."default.png"?>" />
		</div>
	...
	<div class="itemdiv commentdiv">
		<div class="user">
			<img alt="Rita's Avatar" src="<?=AVATAR_IMAGE_URL."default.png"?>" />
		</div>
