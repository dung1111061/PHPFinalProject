...
<div class="col-sm-10 ">
		...
		<script type="text/javascript">
			document.getElementById("new_details").setAttribute("action",
				"new.php?action=edit&id=<?= $new[db_new_id] ?>")
		</script>
</div>
<!--  -->

<div class="col-xs-2" style="text-align: right">
	<div id = "edit-button" class="btn btn-app btn-primary no-radius" data-toggle="tooltip" title="Sửa" onclick="$( '#new_details' ).submit();"> 
