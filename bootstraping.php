...
require_once "config_project.php"; // common configuration
...
spl_autoload_register(function ($name) {
    ...
    //
    if(is_file(ADMIN_PATH."models/$name.php")) 
    	include_once ADMIN_PATH."models/$name.php";
    
    if(is_file(ADMIN_PATH."models/libraries/$name.php")) 
    	include_once ADMIN_PATH."models/libraries/$name.php";
