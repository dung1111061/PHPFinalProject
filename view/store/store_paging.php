...
<!-- Cell contain filter tool for user  -->
	...
	<div class="filter-box wrapper">
		<button class="sticky fixed-filter-apply btn-warning" onclick="submitFilter()">
		 	Ap Dung
		</button>
	</div>
...
<!-- End Cell -->
					...
					<div id="store" class="col-md-9">
						<!-- store top filter -->
						<div class="row">
							<div class="filter-infomation">
								<strong class="text-uppercase"> Bộ lọc: </strong> <?= $filter_info ?> cho ra <span class="mark"> <?= $record_number ?> </span>  kết quả	
								<br>
								<button class="btn">
									Xóa bộ lọc
								</button>
						...
						<div class="row store-body"><!-- product -->
<?php
...
<?php } ?>
					...
					?>	
						...
						<div class="store-filter clearfix">
							<span class="store-qty"> Trưng bày <strong> <?= $max_product?> </strong>  trong <strong> <?= $record_number?> </strong>  sản phẩm </span>
							<ul class="store-pagination">
								<li class="active"><a href="#" data-id="1">1</a></li>
							<?php 
