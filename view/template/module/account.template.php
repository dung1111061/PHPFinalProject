...
?>
<!--  -->
<div id='account' class="dropdown" data-login=<?= $loginFlag ?> >
	<i class="fa fa-user-o"></i> <a href="" data-toggle="dropdown"> <?=$welcomeMessage?> </a>
	<div class="dropdown-menu pull-right">
		<div class="dropdown-item">
		<a href="?controller=customer_controller&action=logout"  > 
			Đăng xuất 
		</a>
		</div>
		<div class="dropdown-item">
		<a href="?controller=customer_controller&action=manager_account">
		 	Quản lí thông tin
		</a>
		</div>
		<div class="dropdown-item">
		<a data-toggle="modal" data-target="#myModal" class="hidden" >
		 	<i class="fa fa-user-o"></i> Đăng nhập
		</a>
		</div>
		<div class="dropdown-item">
		<a class="btn" href="index.php?controller=customer_controller&action=google_login">
